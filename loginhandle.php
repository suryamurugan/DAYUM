...
<a class="navbar-brand" href="login.php">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="homepage.php">FLIP</a>
      </li>
    </ul>
...
<!----- c  --->
      <div class="album py-10 " style="background: white;" >
        <div class="container" style="background: white;">
...
<div class="col-md-4" style="background: white;">  
  <a href="addnew.php" >         
    ...
    <div class="card border-info mb-2" style="max-width: 18rem;cursor: pointer;" href="www.google.com">
    <!-- <div class="shadow-sm p-1 mb-1  rounded">   -->
        
   
    <div class="card-header" ><img src="add.svg" width="60" height="60" class="d-inline-block align-top" alt="" style="margin:5px;"></div>
...
<div class="col-md-4" style="background: white;">  
  <a href="editselect.php" >         
  
    <div class="card border-info mb-2" style="max-width: 18rem;cursor: pointer;" href="www.google.com">
    <!-- <div class="shadow-sm p-1 mb-1  rounded">   -->
    <div class="card-header" ><img src="edit.svg" width="60" height="60" class="d-inline-block align-top" alt="" style="margin:5px;"></div>
      <div class="card-body text-info">
...
<div class="col-md-4" style="background: white;">  
  <a href="homepage.php" >         
    ...
    <div class="card border-info mb-2" style="max-width: 18rem;cursor: pointer;" href="www.google.com">
    <!-- <div class="shadow-sm p-1 mb-1  rounded">   -->
    <div class="card-header" ><img src="book.svg" width="60" height="60" class="d-inline-block align-top" alt="" style="margin:5px;"></div>
      <div class="card-body text-info">
        <h3 class="card-title">FLIP</h3>
        <!--<p class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p>-->
      </div>
    </div>
<!-- </div> -->
